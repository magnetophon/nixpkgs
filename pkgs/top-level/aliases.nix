...
mapAliases ({
  ...
  vdirsyncerStable  = throw "vdirsyncerStable is not supported anymore. Use vdirsyncer instead. For more info, see: https://github.com/NixOS/nixpkgs/issues/103026#issuecomment-723428168";
